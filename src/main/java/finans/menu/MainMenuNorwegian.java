/**
 * 1-Fortsette (Continue)
 * 2-Passord (Password)
 * 3-Lisenseieren (The Licence Owner)
 * 4-Samarbeid (Cooperation)
 * 5-Utvikler (Developer)
 * 6-Hjelp (Help)
 * 7-Ut gang (Exit)
 */
package finans.menu;
...
public class MainMenuNorwegian extends MainMenu {
    ...
    public MainMenuNorwegian(int first, String firstName, int last, String lastName, int option2, String name2, int option3, String name3, int option4, String name4, int option5, String name5, int option6, String name6){
    ...
    public void printMenuOnScreen() {
        System.out.println("Regnskapsmeny - velg: ");
