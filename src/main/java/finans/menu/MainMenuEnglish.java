...
public class MainMenuEnglish extends MainMenu {
    ...
    public MainMenuEnglish(int first, String firstName, int last, String lastName, int option2, String name2, int option3, String name3, int option4, String name4, int option5, String name5, int option6, String name6){
