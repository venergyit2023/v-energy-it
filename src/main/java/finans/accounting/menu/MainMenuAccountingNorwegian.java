...
public class MainMenuAccountingNorwegian extends MainMenuAccounting {
    private int option2;
    ...
    public MainMenuAccountingNorwegian(int first, String firstName, int last, String lastName, int option2, String name2, int option3, String name3, int option4, String name4){
    ...
    public void printMenuOnScreen(){
        System.out.println("Hovedmeny for regnskap - velg: ");
